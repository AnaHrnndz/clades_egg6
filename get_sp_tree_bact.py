...
sci_names_list = []
taxid_ori_list = []
with open('/home/plaza/projects/eggnog6/raw_data/Bacteria_eggNOGv6.species.list') as tablefn:
    for line in tablefn:
...
for leaf in tree:
    ...
    if leaf.name == '2585118':
        leaf.name = '1118061'
    elif leaf.name == '639034':
        leaf.name = '1267535'
...
out_f = open('/home/plaza/projects/eggnog6/ncbi_tree/bact_sp_tree.tsv', 'w')
...
for node in tree.traverse():
    if node is leaf:
        ...
        if node.name in miss_names:
            print (node.name)  


tree.write(format = 1 , outfile = '/home/plaza/projects/eggnog6/ncbi_tree/Bacteria_ncbi.nw')
        #print('miss sp: ', name)
