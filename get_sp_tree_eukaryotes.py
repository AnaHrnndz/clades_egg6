...
sci_names_list = []
taxid_ori_list = []
with open('/home/plaza/projects/eggnog6/raw_data/Eukaryotes_eggNOGv6.species.list') as tablefn:
    for line in tablefn:
...
tree.write(format = 1 , outfile = '/home/plaza/projects/eggnog6/ncbi_tree/Eukaryotes_ncbi.nw')
        #print('miss sp: ', name)
